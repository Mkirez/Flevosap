...
<section class="body">
    ...
    <div style="text-align: left;" class="col-md-8" itemprop="text">
        <p>De grote flessen kom je tegen in je supermarkt.
            ...
            <br>Zoals naar (sport)school of werk, een dagje uit, of in je rugzak op vakantie.
        </p>
        <p>Gezellig samen wat eten en drinken in een café, lunchroom of restaurant?
            <br>Ook daar kun je genieten van de smaak van vers fruit.
            <br>Om zeker te weten dat je de echte krijgt, bestel je niet zo maar een sapje, maar vraag je om Flevosap!</p>
    </div> -->
